...
const socials = [
  {
    ...
    color: "hover:border-[hsl(220,46%,48%)] hover:shadow-[0_0_20px_hsl(220,46%,48%,0.4)]",
    icon: (
  ...
  },
  {
    ...
    color: "hover:border-[hsl(330,70%,50%)] hover:shadow-[0_0_20px_hsl(330,70%,50%,0.4)]",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
  ...
  },
  {
    ...
    color: "hover:border-[hsl(0,0%,80%)] hover:shadow-[0_0_20px_hsl(0,0%,80%,0.4)]",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
